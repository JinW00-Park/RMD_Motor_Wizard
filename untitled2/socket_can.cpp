...
/* Write 8 bytes data */
u_int8_t SOCKET_CAN_PROTO::CAN_WRITE_8BYTES(const u_int32_t sock, const u_int32_t id, const u_int8_t *data, u_int8_t opt)
{
...
// write recvv func for timeout 
        //recv func     
            //struct sockaddr_can addr;
            //socklen_t len = sizeof(addr);
            //int rx_bytes = recvfrom(sock, &frame, sizeof(struct can_frame), 0, (struct sockaddr*)&addr, &len);
        ...
        tv.tv_sec = 1;
        tv.tv_usec =0;
        //setsockopt(sock, SOL_CAN_RAW, SO_RCVTIMEO, (const char*)&tv, sizeof(tv));
        */
