...
/* Support fuction for 8 Bytes CAN communication (CAN_INIT(), CANSEND_8BYTES,CANREAD_8BYTES)*/
class SOCKET_CAN_PROTO{
    ...
    public:
        ...
        u_int8_t CAN_WRITE_8BYTES(const u_int32_t, const u_int32_t, const u_int8_t *, u_int8_t);
